  ...
  private makeCategory = (props: {
    ...
    return (
      <div className={styles.category} key={props.title}>
        <div
          className={styles.categoryHeaderWrapper}
          onClick={() =>
      ...
      <div className={styles.SettingsPage}>
        <div className={styles.header}>
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Button color="primary" variant="contained" onClick={this.saveConfig} size="small">
              Save
            </Button>
          </div>
        </div>
        <div className={styles.list}>
          ...
          <p className={styles.cmsVersion} onClick={() => this.setState({ cmsInfoOpen: true })}>
            Cromwell CMS v.{settings?.cmsInfo?.packages['@cromwell/cms']}
          </p>
        </div>
        <CmsInfo open={this.state.cmsInfoOpen} onClose={() => this.setState({ cmsInfoOpen: false })} />
      </div>
    );
  }
}
