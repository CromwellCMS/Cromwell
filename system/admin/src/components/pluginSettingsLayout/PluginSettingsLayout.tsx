    ...
    <div className={styles.PluginSettingsLayout}>
      {isLoading || props.loading ? (
        ...
        <div className={styles.content}>
          ...
          <Modal open={infoOpen} blurSelector="#root" className={commonStyles.center} onClose={toggleOpenInfo}>
            {infoOpen && props.pluginInfo && <MarketModal data={props.pluginInfo} noInstall />}
          </Modal>
        </div>
      )}
    </div>
