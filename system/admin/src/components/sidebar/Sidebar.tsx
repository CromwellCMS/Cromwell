    ...
    <div className={styles.sidebarContent}>
      <div className={styles.sidebarTop}>
        <div className={styles.sidebarHeader}>
          <div className={styles.logo} style={{ backgroundImage: `url("/admin/static/logo_small_white.svg")` }}></div>
      ...
      <div className={styles.sidebarBottom}>
        ...
        <div className={styles.bottomBlock} style={{ marginRight: '-10px' }} ref={popperAnchorEl}>
  ...
  return (
    <div className={styles.Sidebar}>
      <div className={styles.mobileContent}>
        ...
        <SwipeableDrawer open={mobileOpen} onClose={handleCloseMenu} onOpen={handleOpenMenu}>
