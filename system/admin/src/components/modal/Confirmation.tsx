    ...
    >
      <div className={styles.ConfirmationModal}>
        ...
        <div className={styles.actions}>
          ...
          <TextButton role="button" onClick={props.onConfirm} className={styles.actionBtn} disabled={props.disabled}>
            Ok
          </TextButton>
        </div>
      </div>
...
export class ConfirmPrompt extends React.Component<
  any,
  {
    open: boolean;
    title?: string;
...
export const askConfirmation = async (options?: { title?: string }): Promise<boolean> => {
