...
export class CouponResolver {
  ...
  @Query(() => Coupon)
  async [getOneByIdPath](@Ctx() ctx: TGraphQLContext, @Arg('id', () => Int) id: number): Promise<TCoupon | undefined> {
    return getByIdWithFilters('Coupon', ctx, ['read_coupons'], ['read_coupons'], id, (...args) =>
      this.repository.getCouponById(...args),
    );
  }
  ...
  async [getManyPath](
    ...
    return getManyWithFilters('Coupon', ctx, ['read_coupons'], ['read_coupons'], pagedParams, filterParams, (...args) =>
      this.repository.getFilteredCoupons(...args),
    );
  }
  ...
  async [deletePath](@Ctx() ctx: TGraphQLContext, @Arg('id', () => Int) id: number): Promise<boolean> {
    return deleteWithFilters('Coupon', ctx, ['delete_coupon'], id, (...args) => this.repository.deleteCoupon(...args));
  }
  ...
  async [deleteManyPath](
    ...
    return deleteManyWithFilters('Coupon', ctx, ['delete_coupon'], input, filterParams, (...args) =>
      this.repository.deleteManyFilteredCoupons(...args),
    );
  }
  ...
  @Authorized<TPermissionName>('read_coupons')
  @Query(() => [Coupon])
  async [getCouponsByCodesPath](@Arg('codes', () => [String]) codes: string[]): Promise<TCoupon[] | undefined> {
