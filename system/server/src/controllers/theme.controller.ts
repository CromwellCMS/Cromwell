...
export class ThemeController {
  ...
  async getPageConfig(
    @Query('pageRoute') pageRoute: string,
    @Query('themeName') themeName: string,
  ): Promise<TPageConfig | null> {
    ...
    if (!themeName) throw new HttpException('You must provide `themeName` query parameter', HttpStatus.BAD_REQUEST);
