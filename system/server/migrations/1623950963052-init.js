...
module.exports = class init1623950963052 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query("CREATE TABLE `crw_user` (`id` int NOT NULL AUTO_INCREMENT, `slug` varchar(255) NULL, `pageTitle` varchar(255) NULL, `pageDescription` varchar(255) NULL, `createDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `isEnabled` tinyint NULL DEFAULT 1, `fullName` varchar(255) NULL, `email` varchar(255) NULL, `avatar` varchar(255) NULL, `bio` varchar(6000) NULL, `role` varchar(255) NULL, `address` varchar(1000) NULL, `phone` varchar(255) NULL, `password` varchar(255) NOT NULL, `refreshTokens` varchar(500) NULL, `resetPasswordCode` varchar(255) NULL, `resetPasswordDate` datetime NULL, INDEX `IDX_0537e4a35e2b1842afc531deab` (`fullName`), INDEX `IDX_850a536df6641e90872f905e74` (`role`), INDEX `IDX_644eed41dbcadfe2e3e634ba84` (`phone`), UNIQUE INDEX `IDX_86fcd952549ae797ab020043b2` (`slug`), UNIQUE INDEX `IDX_4544ef20d7756aad6b7a49d813` (`email`), PRIMARY KEY (`id`))");
