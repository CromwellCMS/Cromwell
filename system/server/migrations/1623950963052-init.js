...
module.exports = class init1623950963052 {
    name = 'init1623950963052'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query("CREATE TABLE `crw_theme` (`id` int NOT NULL AUTO_INCREMENT, `slug` varchar(255) NULL, `pageTitle` varchar(255) NULL, `pageDescription` varchar(255) NULL, `createDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `isEnabled` tinyint NULL DEFAULT 1, `name` varchar(255) NOT NULL, `version` varchar(255) NULL, `isInstalled` tinyint NOT NULL, `hasAdminBundle` tinyint NULL, `settings` text NULL, `defaultSettings` text NULL, `moduleInfo` text NULL, `isUpdating` tinyint NULL, UNIQUE INDEX `IDX_05d0c5a03358df4a5fc355eb7f` (`slug`), PRIMARY KEY (`id`))");
        await queryRunner.query("CREATE TABLE `crw_user` (`id` int NOT NULL AUTO_INCREMENT, `slug` varchar(255) NULL, `pageTitle` varchar(255) NULL, `pageDescription` varchar(255) NULL, `createDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `isEnabled` tinyint NULL DEFAULT 1, `fullName` varchar(255) NULL, `email` varchar(255) NULL, `avatar` varchar(255) NULL, `bio` varchar(6000) NULL, `role` varchar(255) NULL, `address` varchar(1000) NULL, `phone` varchar(255) NULL, `password` varchar(255) NOT NULL, `refreshTokens` varchar(5000) NULL, `resetPasswordCode` varchar(255) NULL, `resetPasswordDate` datetime NULL, INDEX `IDX_0537e4a35e2b1842afc531deab` (`fullName`), INDEX `IDX_850a536df6641e90872f905e74` (`role`), INDEX `IDX_644eed41dbcadfe2e3e634ba84` (`phone`), UNIQUE INDEX `IDX_86fcd952549ae797ab020043b2` (`slug`), UNIQUE INDEX `IDX_4544ef20d7756aad6b7a49d813` (`email`), PRIMARY KEY (`id`))");
        await queryRunner.query("CREATE TABLE `crw_post_tags_tag` (`postId` int NOT NULL, `tagId` int NOT NULL, INDEX `IDX_f24f47df26e67c493b68bfc75b` (`postId`), INDEX `IDX_6c786f2afb686050d8233fdc6e` (`tagId`), PRIMARY KEY (`postId`, `tagId`))");
        await queryRunner.query("CREATE TABLE `crw_product_categories_product_category` (`productId` int NOT NULL, `productCategoryId` int NOT NULL, INDEX `IDX_8056740044bde85c6535e4cc6c` (`productId`), INDEX `IDX_f4f41beb6142f70af17b37ff50` (`productCategoryId`), PRIMARY KEY (`productId`, `productCategoryId`))");
        await queryRunner.query("CREATE TABLE `crw_product_category_closure` (`id_ancestor` int NOT NULL, `id_descendant` int NOT NULL, INDEX `IDX_9463c9a5893b1efb969e9a21c5` (`id_ancestor`), INDEX `IDX_bc8936d152e18bc99150472594` (`id_descendant`), PRIMARY KEY (`id_ancestor`, `id_descendant`))");
