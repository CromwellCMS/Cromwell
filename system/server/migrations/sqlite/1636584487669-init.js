...
module.exports = class init1636584487669 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "crw_user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "slug" varchar(255), "pageTitle" varchar(2000), "pageDescription" varchar(4000), "_meta" text, "createDate" datetime NOT NULL DEFAULT (datetime('now')), "updateDate" datetime NOT NULL DEFAULT (datetime('now')), "isEnabled" boolean DEFAULT (1), "fullName" varchar(255), "email" varchar(255), "avatar" varchar, "bio" text, "role" varchar(50), "address" varchar(1000), "phone" varchar(255), "password" varchar(255) NOT NULL, "refreshTokens" varchar(5000), "resetPasswordCode" varchar(255), "resetPasswordDate" datetime, CONSTRAINT "UQ_86fcd952549ae797ab020043b23" UNIQUE ("slug"), CONSTRAINT "UQ_4544ef20d7756aad6b7a49d8133" UNIQUE ("email"))`);
