...
module.exports = class coupons1638975054101 {
  ...
  async down(queryRunner) {
    await queryRunner.query(
      `ALTER TABLE \`crw_order_coupons_coupon\` DROP FOREIGN KEY \`FK_22d6089b34dabf8e84ecdd3cd96\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`crw_order_coupons_coupon\` DROP FOREIGN KEY \`FK_59198cce77c3b44f2e9ac470082\``,
    );
