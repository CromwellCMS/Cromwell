...
module.exports = class init1628591689298 {
    name = 'init1628591689298'

    async up(queryRunner) {
        await queryRunner.query("CREATE TABLE `crw_base_page_entity` (`id` int NOT NULL AUTO_INCREMENT, `slug` varchar(255) NULL, `pageTitle` varchar(255) NULL, `pageDescription` varchar(255) NULL, `createDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `isEnabled` tinyint NULL DEFAULT 1, INDEX `IDX_f90bc99c36e17ac27bea436a52` (`id`), INDEX `IDX_a116d8b9d2048f023d19efe688` (`createDate`), INDEX `IDX_844fa3c3d939e6239a0db732c6` (`updateDate`), UNIQUE INDEX `IDX_33d156210ae42177f24eb55b52` (`slug`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `crw_attribute` (`id` int NOT NULL AUTO_INCREMENT, `slug` varchar(255) NULL, `pageTitle` varchar(255) NULL, `pageDescription` varchar(255) NULL, `createDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `isEnabled` tinyint NULL DEFAULT 1, `key` varchar(255) NOT NULL, `valuesJSON` text NULL, `type` varchar(255) NOT NULL, `icon` varchar(300) NULL, `required` tinyint NULL, INDEX `IDX_14123e1bfce87c730d9f9b2e7e` (`id`), INDEX `IDX_8ef1078c7f634d29bfa7970d4a` (`createDate`), INDEX `IDX_53dcf0d02fa3d06e1e68790cff` (`updateDate`), UNIQUE INDEX `IDX_21d04deefef2e9d62ed19ba759` (`slug`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `crw_cms` (`id` int NOT NULL AUTO_INCREMENT, `slug` varchar(255) NULL, `pageTitle` varchar(255) NULL, `pageDescription` varchar(255) NULL, `createDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `isEnabled` tinyint NULL DEFAULT 1, `_publicSettings` text NULL, `_adminSettings` text NULL, `_internalSettings` text NULL, INDEX `IDX_35aee121b80f1702414cd3d86a` (`id`), INDEX `IDX_29b7f30f5cacfd369a34125a98` (`createDate`), INDEX `IDX_11992283fb607b2ce95106e243` (`updateDate`), UNIQUE INDEX `IDX_45a249e9f534b6af909ffedf0d` (`slug`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `crw_order` (`id` int NOT NULL AUTO_INCREMENT, `slug` varchar(255) NULL, `pageTitle` varchar(255) NULL, `pageDescription` varchar(255) NULL, `createDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `isEnabled` tinyint NULL DEFAULT 1, `status` varchar(255) NULL, `cart` text NULL, `orderTotalPrice` float NULL, `cartTotalPrice` float NULL, `cartOldTotalPrice` float NULL, `shippingPrice` float NULL, `totalQnt` float NULL, `userId` varchar(255) NULL, `customerName` varchar(255) NULL, `customerPhone` varchar(255) NULL, `customerEmail` varchar(255) NULL, `customerAddress` varchar(255) NULL, `shippingMethod` varchar(255) NULL, `paymentMethod` varchar(255) NULL, `customerComment` varchar(255) NULL, `currency` varchar(255) NULL, INDEX `IDX_f9516631047341dd5a92da55ed` (`id`), INDEX `IDX_0d853efe1210ed00263c0551fb` (`createDate`), INDEX `IDX_d4300abf3566bc4a63ca0b12c5` (`updateDate`), INDEX `IDX_56caac5bbc2683720ddd655a23` (`status`), INDEX `IDX_86c22318de90222b57a2f0ac90` (`userId`), INDEX `IDX_a71afe78a44fdebe245d06c0fb` (`customerName`), INDEX `IDX_8bb01ee9a429f70390bbedbaf6` (`customerPhone`), INDEX `IDX_0d115ee42c627f4c5f5ea6d12a` (`customerEmail`), UNIQUE INDEX `IDX_7a2428bdc18f7abd3758570668` (`slug`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query("DROP INDEX `IDX_d1e2d7b6f6f40bef308ba789a9` ON `crw_user`");
        ...
        await queryRunner.query("DROP INDEX `IDX_e1ce51262721c84f8d0b0e167c` ON `crw_theme`");
        ...
        await queryRunner.query("DROP INDEX `IDX_eb9777ea5f5b04f2cbba1e0af0` ON `crw_product`");
        ...
        await queryRunner.query("DROP INDEX `IDX_a5cf4a8450a9f6dbd2652a83fc` ON `crw_product_review`");
        ...
        await queryRunner.query("DROP INDEX `IDX_59bfab9f694d339b5c3c857459` ON `crw_product_category`");
        ...
        await queryRunner.query("DROP INDEX `IDX_5ab22641659adcdaff7704b6c5` ON `crw_post`");
        ...
        await queryRunner.query("DROP INDEX `IDX_9f320f9f26d7779a37a1202d09` ON `crw_tag`");
        ...
        await queryRunner.query("DROP INDEX `IDX_29b13761ab698fe448554a3e38` ON `crw_post_comment`");
        ...
        await queryRunner.query("DROP INDEX `IDX_89a31be444f5f741a1d247f627` ON `crw_plugin`");
        ...
        await queryRunner.query("DROP INDEX `IDX_14123e1bfce87c730d9f9b2e7e` ON `crw_attribute`");
        ...
        await queryRunner.query("DROP INDEX `IDX_f90bc99c36e17ac27bea436a52` ON `crw_base_page_entity`");
