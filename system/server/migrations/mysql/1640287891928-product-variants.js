...
module.exports = class productVariants1640287891928 {
  ...
  async up(queryRunner) {
    await queryRunner.query(
      `CREATE TABLE \`crw_product_variant_meta\` (\`id\` int NOT NULL AUTO_INCREMENT, \`key\` varchar(255) NULL, \`value\` text NULL, \`shortValue\` varchar(255) NULL, \`entityId\` int NOT NULL, INDEX \`IDX_043b6fccace5ccd18abcd0472d\` (\`key\`), FULLTEXT INDEX \`IDX_5d353c6757ba25557fcaa97b16\` (\`shortValue\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
  ...
  async down(queryRunner) {
    ...
    await queryRunner.query(
      `ALTER TABLE \`crw_product_variant_meta\` DROP FOREIGN KEY \`FK_f2833cc1e1bb9516471b126327e\``,
    );
