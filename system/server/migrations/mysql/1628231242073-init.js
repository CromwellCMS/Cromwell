...
module.exports = class init1628231242073 {
    name = 'init1628231242073'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query("CREATE TABLE `crw_cms` (`id` int NOT NULL AUTO_INCREMENT, `slug` varchar(255) NULL, `pageTitle` varchar(255) NULL, `pageDescription` varchar(255) NULL, `createDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `isEnabled` tinyint NULL DEFAULT 1, `_publicSettings` text NULL, `_adminSettings` text NULL, `_internalSettings` text NULL, UNIQUE INDEX `IDX_45a249e9f534b6af909ffedf0d` (`slug`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `crw_page_stats` (`id` int NOT NULL AUTO_INCREMENT, `pageRoute` varchar(255) NOT NULL, `pageName` varchar(255) NULL, `pageId` varchar(255) NULL, `views` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
