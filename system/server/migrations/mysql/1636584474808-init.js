...
module.exports = class init1636584474808 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`crw_base_entity_meta\` (\`id\` int NOT NULL AUTO_INCREMENT, \`key\` varchar(255) NULL, \`value\` text NULL, \`shortValue\` varchar(255) NULL, INDEX \`IDX_3d0d518265cf6018bf3e488f30\` (\`key\`), FULLTEXT INDEX \`IDX_b1fb7b510a52f67bb8bbc02b80\` (\`shortValue\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`crw_attribute_meta\` (\`id\` int NOT NULL AUTO_INCREMENT, \`key\` varchar(255) NULL, \`value\` text NULL, \`shortValue\` varchar(255) NULL, \`entityId\` int NOT NULL, INDEX \`IDX_bbdf61b39e061e316700b803b2\` (\`key\`), FULLTEXT INDEX \`IDX_cfc226f441aa035681ca94d791\` (\`shortValue\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`crw_tag_meta\` (\`id\` int NOT NULL AUTO_INCREMENT, \`key\` varchar(255) NULL, \`value\` text NULL, \`shortValue\` varchar(255) NULL, \`entityId\` int NOT NULL, INDEX \`IDX_f8c8425742699651cf5f7c12e0\` (\`key\`), FULLTEXT INDEX \`IDX_17920baaeed623ba12afefa4b2\` (\`shortValue\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`crw_user_meta\` (\`id\` int NOT NULL AUTO_INCREMENT, \`key\` varchar(255) NULL, \`value\` text NULL, \`shortValue\` varchar(255) NULL, \`entityId\` int NOT NULL, INDEX \`IDX_be55edbbdc5da3712ab5270b61\` (\`key\`), FULLTEXT INDEX \`IDX_ac05041d8a345ef9bcf4df886c\` (\`shortValue\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`crw_post_meta\` (\`id\` int NOT NULL AUTO_INCREMENT, \`key\` varchar(255) NULL, \`value\` text NULL, \`shortValue\` varchar(255) NULL, \`entityId\` int NOT NULL, INDEX \`IDX_a6e8f93e58953b3440e4ce8e97\` (\`key\`), FULLTEXT INDEX \`IDX_f88f049ff16c909c2117a3b737\` (\`shortValue\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`crw_page_stats\` (\`id\` int NOT NULL AUTO_INCREMENT, \`pageRoute\` varchar(255) NOT NULL, \`pageName\` varchar(255) NULL, \`pageId\` varchar(255) NULL, \`views\` int NULL, \`slug\` varchar(255) NULL, \`entityType\` varchar(255) NULL, INDEX \`IDX_b77d858a4e600256c226b71e7d\` (\`slug\`), INDEX \`IDX_1f6131609d99f50bc4da4b9333\` (\`entityType\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`crw_custom_entity_meta\` DROP FOREIGN KEY \`FK_9339113c97fb03140bf2765fc41\``);
        await queryRunner.query(`ALTER TABLE \`crw_attribute_to_product\` DROP FOREIGN KEY \`FK_6a9b506859de7cc2ac65414ec95\``);
        await queryRunner.query(`ALTER TABLE \`crw_attribute_to_product\` DROP FOREIGN KEY \`FK_533b299ee136f75e261be4ebcf1\``);
        ...
        await queryRunner.query(`ALTER TABLE \`crw_product_category_meta\` DROP FOREIGN KEY \`FK_c850099194d3cd3a991634bc12d\``);
