...
module.exports = class init1636584474808 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`crw_attribute_to_product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`productId\` int NULL, \`attributeValueId\` int NULL, \`key\` varchar(255) NOT NULL, \`value\` varchar(255) NULL, INDEX \`IDX_533b299ee136f75e261be4ebcf\` (\`productId\`), INDEX \`IDX_6a9b506859de7cc2ac65414ec9\` (\`attributeValueId\`), INDEX \`IDX_d4292415b7431d518278318057\` (\`key\`), INDEX \`IDX_854e20470498807068e94d87a8\` (\`value\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
