...
module.exports = class init1627964284323 {
    name = 'init1627964284323'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query("CREATE TABLE `crw_page_stats` (`id` int NOT NULL AUTO_INCREMENT, `pageRoute` varchar(255) NOT NULL, `pageName` int NULL, `pageId` varchar(255) NULL, `views` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
