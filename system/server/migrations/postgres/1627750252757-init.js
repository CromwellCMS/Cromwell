...
module.exports = class init1627750252757 {
    name = 'init1627750252757'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "crw_cms" ("id" SERIAL NOT NULL, "slug" character varying, "pageTitle" character varying, "pageDescription" character varying, "createDate" TIMESTAMP NOT NULL DEFAULT now(), "updateDate" TIMESTAMP NOT NULL DEFAULT now(), "isEnabled" boolean DEFAULT true, "themeName" character varying NOT NULL, "protocol" character varying, "defaultPageSize" integer, "timezone" integer, "language" character varying, "favicon" character varying(300), "logo" character varying(300), "headHtml" text, "footerHtml" text, "defaultShippingPrice" double precision, "_currencies" text, "version" character varying, "versions" character varying(2000), "installed" boolean, "beta" boolean, "smtpConnectionString" character varying(400), "sendFromEmail" character varying, "isUpdating" boolean, "_adminSettings" text, CONSTRAINT "UQ_45a249e9f534b6af909ffedf0d2" UNIQUE ("slug"), CONSTRAINT "PK_35aee121b80f1702414cd3d86a1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "crw_page_stats" ("id" SERIAL NOT NULL, "pageRoute" character varying NOT NULL, "views" integer, "productSlug" character varying, "categorySlug" character varying, "postSlug" character varying, "tagSlug" character varying, "pageId" character varying, CONSTRAINT "PK_f774ad09d3d69ddbdef96705010" PRIMARY KEY ("id"))`);
