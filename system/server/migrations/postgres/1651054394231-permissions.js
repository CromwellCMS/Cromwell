...
module.exports = class permissions1651054394231 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "crw_role_meta" ("id" SERIAL NOT NULL, "key" character varying(255), "value" text, "shortValue" character varying(255), "entityId" integer NOT NULL, CONSTRAINT "PK_584dad5524fbe2885a164b77ff0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "crw_role" ("id" SERIAL NOT NULL, "slug" character varying(255), "pageTitle" character varying(2000), "pageDescription" character varying(4000), "_meta" text, "createDate" TIMESTAMP NOT NULL DEFAULT now(), "updateDate" TIMESTAMP NOT NULL DEFAULT now(), "isEnabled" boolean DEFAULT true, "name" character varying(255), "title" character varying(255), "icon" character varying(255), "permissions" text, CONSTRAINT "UQ_87aa9675ec190f3eb2f29fe2ad9" UNIQUE ("slug"), CONSTRAINT "PK_1a4502bc17c5be2d5d1029c371e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "crw_user_roles_role" ("userId" integer NOT NULL, "roleId" integer NOT NULL, CONSTRAINT "PK_5c4841bf8690f80844d47ab8bcd" PRIMARY KEY ("userId", "roleId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "crw_role_meta" ADD CONSTRAINT "FK_ebe8676ea6dcf9a29c85579112a" FOREIGN KEY ("entityId") REFERENCES "crw_role"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "crw_user_roles_role" ADD CONSTRAINT "FK_86e2ad2823a8f16cffae290465b" FOREIGN KEY ("userId") REFERENCES "crw_user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "crw_user_roles_role" ADD CONSTRAINT "FK_f5f27a36e32615ebf1e9a6ab821" FOREIGN KEY ("roleId") REFERENCES "crw_role"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
