...
module.exports = class coupons1638975061796 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "crw_coupon_meta" ("id" SERIAL NOT NULL, "key" character varying(255), "value" text, "shortValue" character varying(255), "entityId" integer NOT NULL, CONSTRAINT "PK_85cc2fdfd2d37b867fcebece6e4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "crw_coupon" ("id" SERIAL NOT NULL, "slug" character varying(255), "pageTitle" character varying(2000), "pageDescription" character varying(4000), "_meta" text, "createDate" TIMESTAMP NOT NULL DEFAULT now(), "updateDate" TIMESTAMP NOT NULL DEFAULT now(), "isEnabled" boolean DEFAULT true, "discountType" character varying(255) NOT NULL, "value" double precision, "code" character varying(255) NOT NULL, "description" character varying(3000), "allowFreeShipping" boolean, "minimumSpend" double precision, "maximumSpend" double precision, "categoryIds" text, "productIds" text, "expiryDate" TIMESTAMP, "usageLimit" integer, "usedTimes" integer, CONSTRAINT "UQ_a42d0cda340107e201bb3145f94" UNIQUE ("slug"), CONSTRAINT "PK_1353a0953afeb2f334ebf61b560" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "crw_order_coupons_coupon" ("orderId" integer NOT NULL, "couponId" integer NOT NULL, CONSTRAINT "PK_6dacd4268a5b0d38b0451ba3a4d" PRIMARY KEY ("orderId", "couponId"))`);
