...
module.exports = class productVariants1640287895984 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "crw_product_variant_meta" ("id" SERIAL NOT NULL, "key" character varying(255), "value" text, "shortValue" character varying(255), "entityId" integer NOT NULL, CONSTRAINT "PK_f406ff1aac1e9765e057afd4294" PRIMARY KEY ("id"))`);
