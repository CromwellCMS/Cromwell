...
export const BlockIcon = ({ bType }) => {
  ...
  switch (bType) {
    case 'text': {
      icon = <MenuAlt2Icon className="h-5 pb-1 w-5 inline-block" />;
      break;
    }
    case 'container': {
    ...
    case 'plugin': {
      icon = <PuzzleIcon className="h-5 pb-1 w-5 inline-block" />;
      break;
    }
    case 'HTML': {
    ...
    case 'image': {
      icon = <PhotographIcon className="h-5 pb-1 w-5 inline-block" />;
      break;
    }
    case 'link': {
    ...
    case 'gallery': {
      icon = <CollectionIcon className="h-5 pb-1 w-5 inline-block" />;
      break;
    }
    case 'editor': {
