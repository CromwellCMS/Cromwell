...
const exportOptions = [
  ...
  },
  {
    ...
    checked: true,
    description:
      "All custom product attributes (meta fields) including id, key, values, type, icon.",
  },
  {
    key: "Coupon",
    title: "Coupons",
  ...
  },
  {
    ...
    checked: true,
    description:
      "All post tags including id, name, color, image link and description.",
  },
  {
    key: "Order",
    title: "Orders",
  ...
  },
  {
    ...
    checked: true,
    description:
      "All custom entities including it's meta field settings.",
  },
  {
    key: "Plugin",
    title: "Plugins",
          ...
          <div
            ...
            <div className="flex flex-wrap">
              {exportOptions.map((opt, idx) => (
                <div
                  key={opt.key}
                  className="max-h-[200px] p-1 basis-full lg:basis-1/2">
                  <ControlledBackupOption
                    key={opt.key}
                    name={`exportData.${idx}.checked`}
                    data={opt}
                  />
                </div>
              ))}
        ...
        <div className="flex flex-col mt-10 z-4 gap-6 relative lg:flex-row">
          <div className="max-h-min max-w-md my-4 top-16 self-start lg:order-2 lg:sticky">
            ...
            <p className="text-red-600">
              Warning: This may override all your data. Use
              with caution.
            </p>
          </div>
            ...
            <div className="flex flex-wrap">
              <div className="max-h-[200px] p-1 basis-full lg:basis-1/2">
                <ControlledBackupOption
                  ...
                  data={{
                    ...
                    checked: false,
                    description:
                      "Delete all data that is not in the backup file.",
              ...
              {override && (
                <p className="font-bold my-3 px-2 text-red-600">
                  Warning: This will override all data and
                  remove items that are not in the backup
