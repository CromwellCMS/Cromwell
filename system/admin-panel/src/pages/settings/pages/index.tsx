import { CloudIcon, CodeIcon, CogIcon, SearchIcon, SwitchVerticalIcon, UserGroupIcon } from '@heroicons/react/outline';
      ...
      <div className="grid gap-6 grid-cols-1 xl:grid-cols-2">
        <div className="bg-white rounded-lg shadow-lg w-full p-4">
          <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
            ...
            <SettingItem
              href="/settings/seo"
              icon={<SearchIcon className="mx-auto h-8 w-8 self-center" />}
              title="SEO"
            ...
            <SettingItem
              href="/themes"
              icon={<TemplateIcon className="mx-auto h-8 w-8 self-center" />}
              title="Themes"
            ...
            <SettingItem
              ...
              icon={<SwitchVerticalIcon className="mx-auto h-8 w-8 self-center" />}
            ...
            <SettingItem
              href="/settings/code"
              icon={<CodeIcon className="mx-auto h-8 w-8 self-center" />}
