          ...
          <div className="grid gap-2 grid-cols-1">
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
              <SettingItem
                ...
                icon={
                  <ShoppingBagIcon className="mx-auto h-8 w-8 self-center" />
                }
                title="Product"
              ...
              <SettingItem
                ...
                icon={
                  <HashtagIcon className="mx-auto h-8 w-8 self-center" />
                }
                title="Category"
              ...
              <SettingItem
                ...
                icon={
                  <DuplicateIcon className="mx-auto h-8 w-8 self-center" />
                }
                title="Post"
              ...
              <SettingItem
                ...
                icon={
                  <TagIcon className="mx-auto h-8 w-8 self-center" />
                }
                title="Tag"
              ...
              <SettingItem
                ...
                icon={
                  <UserIcon className="mx-auto h-8 w-8 self-center" />
                }
                title="User"
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
              {
                adminSettings.customEntities?.map((entity) => {
                  ...
                  <SettingItem
                    ...
                    icon={ entity.icon && entity.icon !== "" ? <img src={entity.icon} width="32px" height="32px" alt={entity.listLabel} className="mx-auto h-8 w-8 self-center" /> :
