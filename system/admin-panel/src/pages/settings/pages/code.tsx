      ...
      <form
        ...
        <div className="flex flex-col z-4 gap-6 relative lg:flex-row">
          <div className="max-h-min my-4 lg:max-w-[13rem] top-16 self-start lg:order-2 lg:sticky">
            ...
            <p>Code under Head will be placed on the {"<head></head>"} section of the website.
            Footer HTML will be placed at the bottom of {"<body />"}.</p>
            <p className="text-red-600">Warning: This is a feature for tech-experts. Please use with caution and do not inject any malicious code.</p>
            <p
              className={`${
                isDirty
                  ? "text-indigo-500"
