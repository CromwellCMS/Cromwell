            ...
            <div className="min-h-screen text-center px-4">
              ...
              >
                <div className="bg-white max-w-xl rounded-2xl shadow-xl my-8 text-left w-full p-6 transform transition-all inline-block overflow-hidden align-middle">
                  ...
                  <div className="my-2">
                    <p className="text-sm text-gray-500">
                      Add a new custom entity to the system.
                    </p>
                  </div>
                  ...
                  <div className="grid gap-2 grid-cols-1">
                    <TextInputField
                      ...
                      {...register("entityLabel", { required: true, onChange: (event) => {
                    ...
                    <TextInputField
                      ...
                      placeholder="my-custom-entity"
                      required
                      error={uniqError ? "An Entity with the same Entity Type already exists. Please change the entity type." : null}
                      ...
                      {...register("entityType", { required: true, onChange: (event) => {
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-400">SVG Vector files with {'fill="currentColor"'} work best as icons.</p>
                  </div>
                </div>
