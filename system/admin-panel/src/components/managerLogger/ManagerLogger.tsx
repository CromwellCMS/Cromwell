...
export const ManagerLogger = (props: { isActive: boolean }) => {
  ...
  if (props.isActive && !lastState.current) {
    ...
    toastId.current = toast(({ closeToast }) => <Notification onClose={closeToast} onClick={handleOpenModal} />, {
  ...
  return (
    <Modal className={commonClasses.center} open={isModalActive} onClose={() => setIsModalActive(false)}>
...
const Notification = (props: { onClose?: () => void; onClick: () => void }) => {
  return (
    <div className={classes.notification}>
      <p className={classes.notificationLink} onClick={props.onClick}>
