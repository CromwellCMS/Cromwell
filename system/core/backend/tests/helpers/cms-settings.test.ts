...
describe('cms config / settings', () => {
  ...
  it('read cms config and and return default settings', () => {
    ...
    expect(config.defaultSettings?.publicSettings?.defaultPageSize).toEqual(
      defaultCmsConfig.defaultSettings?.publicSettings?.defaultPageSize,
    );
  });
  ...
  it('creates new cms entity with default settings', async () => {
    ...
    expect(entity.publicSettings?.defaultPageSize).toEqual(
      defaultCmsConfig?.defaultSettings?.publicSettings?.defaultPageSize,
    );
