...
export class CRestApiClient {
   ...
   * @auth admin
   */
  public saveCmsSettings = async (
    input: TCmsSettings & {
      robotsContent?: string;
    },
    options?: TRequestOptions,
  ): Promise<TCmsSettings | undefined> => {
  ...
  /** @internal */
  public setupCmsFirstStep = async (
    input: {
      user: TCreateUser;
    },
    options?: TRequestOptions,
  ...
  /** @internal */
  public setupCmsSecondStep = async (
    input: {
      url: string;
  ...
  public createPaymentSession = async (
    ...
    options?: TRequestOptions,
  ): Promise<TOrderPaymentSession | undefined> => {
   ...
   * @auth no
   */
  public placeProductReview = async (
    input: TProductReviewInput,
    options?: TRequestOptions,
  ): Promise<TProductReview | undefined> => {
   ...
   * @auth no
   */
  public getPageConfig = async (
    pageRoute: string,
    themeName: string,
    options?: TRequestOptions,
  ): Promise<TPageConfig | undefined> => {
   ...
   * @auth no
   */
  public getThemeInfo = async (
    themeName: string,
    options?: TRequestOptions,
  ): Promise<TPackageCromwellConfig | undefined> => {
  ...
  /** @internal */
  public getThemeCustomConfig = async (
    themeName: string,
    options?: TRequestOptions,
  ...
  public purgeRendererPageCache = async (pageRoute: string, options?: TRequestOptions): Promise<any> => {
    return this.get(
      `v1/renderer/purge-page-cache?pageRoute=${pageRoute}`,
      options ?? {
        disableLog: true,
      },
    );
  ...
  public purgeRendererEntireCache = async (options?: TRequestOptions): Promise<any> => {
    return this.get(
      `v1/renderer/purge-entire-cache`,
      options ?? {
        disableLog: true,
      },
    );
   ...
   * @auth admin
   */
  public savePluginSettings = async (
    pluginName: string,
    settings: any,
    options?: TRequestOptions,
  ): Promise<boolean> => {
   ...
   * @auth admin
   */
  public getPluginEntity = async (
    pluginName: string,
    options?: TRequestOptions,
  ): Promise<TPluginEntity | undefined> => {
   ...
   * @auth no
   */
  public getPluginFrontendBundle = async (
    pluginName: string,
    options?: TRequestOptions,
   ...
   * @auth no
   */
  public getPluginAdminBundle = async (
    pluginName: string,
    options?: TRequestOptions,
  ): Promise<TFrontendBundle | undefined> => {
