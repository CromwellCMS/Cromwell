...
export const { Consumer: BlockContentConsumer, Provider: BlockContentProvider } =
  React.createContext<TBlockContentProvider | null>(null);
export const { Consumer: BlockStoreConsumer, Provider: BlockStoreProvider } =
  React.createContext<TBlockStoreProvider | null>(null);
