module.exports = {
  ...
  globalCss: ['react-toastify/dist/ReactToastify.css', './src/styles/global.scss'],
  headHtml:
    '<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;600;700;900&display=swap" rel="stylesheet" /><meta name="viewport" content="width=device-width"><meta property="og:appConfig_headHtml" content="blah_blah" key="blah_blah" />',
  defaultPages: {
    index: 'index',
    post: 'post/[slug]',
    tag: 'tag/[slug]',
      ...
      modifications: [
        {
          ...
          html: {
            innerHTML:
              '<h1>Attribution</h1><div id="icons_attribution" style={{ fontSize: \'12px\' }}>Icons made by <a href="http://www.freepik.com/" title="Freepik">Freepik</a> from <a href="https://www.flaticon.com/" title="Flaticon"> www.flaticon.com</a></div>',
          },
        },
      ],
    },
