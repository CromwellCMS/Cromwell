      ...
      <CContainer className={commonStyles.content} id="footer_02">
        <CContainer className={styles.aboutSection} id="footer_08">
          <CContainer className={styles.linksBlock} id="footer_09">
            ...
            <CText href="/pages/attribution" className={styles.blockLink} id="footer_31">
              Attribution
            </CText>
          </CContainer>
          <CContainer className={styles.linksBlock} id="footer_22">
            ...
            <CText href="/pages/contacts" className={styles.blockLink} id="footer_27">
              Contacts
            </CText>
            <CText href="/post/join-us" className={styles.blockLink} id="footer_26">
              Join Us
            </CText>
            <CText href="/search" className={styles.blockLink} id="footer_28">
              Search posts
            </CText>
          </CContainer>
          <CContainer className={styles.linksBlock} id="footer_17">
            <CText className={styles.blockHeader} id="footer_07">
              Join our newsletter!
            </CText>
