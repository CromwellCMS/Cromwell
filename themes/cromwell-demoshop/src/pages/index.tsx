                ...
                <CContainer id="main_20" className={commonStyles.content}>
                    <CContainer id="main_20" className={styles.mainBlock}>
                        <CContainer id="main_21" className={styles.mainSidebar}>
                            <CImage id="main_sidebar_image_1" src="/themes/cromwell-demoshop/sidebar_banner_1.png" className={styles.sidebarBanner} />
                        ...
                        <CContainer id="main_22" className={styles.mainContent}>
                            <CContainer id="main_23" className={styles.mainSubBanners}>
                                <CImage src="/themes/cromwell-demoshop/sub_banner_1.jpg" id="main_sub_banner_1" className={styles.mainSubBanner} />
                                <CImage src="/themes/cromwell-demoshop/sub_banner_2.jpg" id="main_sub_banner_2" className={styles.mainSubBanner} />
                                <CImage src="/themes/cromwell-demoshop/sub_banner_3.jpg" id="main_sub_banner_3" className={styles.mainSubBanner} />
                            </CContainer>
