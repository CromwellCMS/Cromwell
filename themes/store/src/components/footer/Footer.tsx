      ...
      <CContainer className={commonStyles.content} id="footer_02">
        ...
        <CContainer className={styles.linksSection} id="footer_08">
          ...
          <CContainer className={styles.linksBlock} id="footer_17">
            ...
            <CText className={styles.blockLink} href="/pages/shipping" id="footer_19">Shipping and Delivery</CText>
            <CText className={styles.blockLink} href="/pages/returns" id="footer_20">Returns</CText>
            <CText className={styles.blockLink} href="/pages/gift-cards" id="footer_21">Gift cards</CText>
          </CContainer>
