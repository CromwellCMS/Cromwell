import {
  ...
  ProductGallery,
  useProductVariants,
} from '@cromwell/toolkit-commerce';
    ...
    >
      <CContainer id="product_0" className={styles.imageAndCaptionBlock}>
        <CContainer id="product_2" className={styles.imageBlock}>
          <ProductGallery product={productVariant} noImagePlaceholder="/themes/@cromwell/theme-store/no-photos.png" />
        </CContainer>
        <CContainer id="product_3" className={styles.captionBlock}>
          ...
          <CContainer id="product_13" className={styles.ratingBlock}>
            ...
            {!!productVariant?.rating?.reviewsNumber && (
              <a className={styles.ratingCaption} onClick={scrollToReviews}>
                ({productVariant?.rating?.average ? productVariant?.rating?.average.toFixed(2) : ''}){' '}
                {productVariant?.rating?.reviewsNumber} reviews.
              </a>
            )}
          </CContainer>
          ...
          <CContainer id="productActionsBlock">
            <MuiProductAttributes attributes={attributes || undefined} product={originalProduct} />
