...
var CromwellBlock = /** @class */ (function (_super) {
    ...
    function CromwellBlock(props) {
        ...
        _this.getVirtualBlocks = function (postion) {
            return _this.virtualBlocks.filter(function (b) { return b.destinationPosition === postion; })
                .map(function (b) { return React.createElement(CromwellBlock, { id: b.componentId, key: b.componentId }); });
        };
    ...
    CromwellBlock.prototype.render = function () {
        if (getCromwellBlockId(this.props.id) !== this.id) {
            return React.createElement("div", { style: { color: 'red' } }, "Error. Block id was changed");
        }
        ...
        var element = (React.createElement(React.Fragment, null,
            this.hasPortalBefore && (React.createElement("div", { id: this.idBefore, key: this.idBefore, className: "CromwellBlockWrapper" }, this.getVirtualBlocks('before'))),
            React.createElement("div", { id: this.id, key: this.id, className: elementClassName, ref: this.blockRef },
                this.props.children,
                this.getVirtualBlocks('inside')),
            this.hasPortalAfter && (React.createElement("div", { id: this.idAfter, key: this.idAfter, className: "CromwellBlockWrapper" }, this.getVirtualBlocks('after')))));
...
function CromwellModule(Component, moduleName) {
    return function () {
        ...
        return (React.createElement("div", { className: "BaseComponent" },
            React.createElement(Component, __assign({}, data))));
    };
}
...
export { CromwellBlock, CromwellModule, DBTableNames, GraphQLPaths, componentsCachePath, getGraphQLClient, getModulesData, getStoreItem, isServer, setModulesData, setStoreItem };
