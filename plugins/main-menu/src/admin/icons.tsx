...
export const DoneIcon = iconFromPath(<path d="M9 16.2 4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z"></path>);
export const HighlightOffIcon = iconFromPath(
...
export const ReorderIcon = iconFromPath(<path d="M3 15h18v-2H3v2zm0 4h18v-2H3v2zm0-8h18V9H3v2zm0-6v2h18V5H3z"></path>);
