...
import { Alert, AlertProps, Button, Input, Tooltip } from '@mui/material';
  ...
  return (
    <div className={classes.subscribeInputContainer}>
      {hasSubscribed ? (
        ...
        <>
          <Tooltip open={canValidate && !validateEmail(email)} title="Invalid e-mail" arrow>
            <Input
          ...
          <Button onClick={submit} variant="contained" color="primary" className={classes.subscribeBtn}>
            Subscribe!
          </Button>
        </>
      )}
