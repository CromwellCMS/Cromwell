      ...
      <div className={styles.IndexPage}>
        <div className={styles.content}>
          ...
          <div>
            <p className={styles.quote}>
              Cromwell CMS is a next-gen e-commerce and blogging platform that unites bleeding-edge web techs in
              extraordinary user-friendly format.
            </p>
          </div>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.sectionSubHeader}>
            Install properly crafted themes by frontend developers. Drag and drop theme blocks. Add plugins, change
            content, styles and more. Make it yours!
          </p>
          <br style={{ height: '20px' }} />
        </div>
        <CoverFlowImages images={['/img/demo-theme-editor.mp4']} />
        ...
        <CoverFlowImages images={['/img/demo-editor.jpg', '/img/demo-filemanager.png']} />
        ...
        <CoverFlowImages images={['/img/demo-dashboard.mp4', '/img/demo-sysusage.png']} />
        ...
        <CoverFlowImages images={['/img/demo-custom1.png', '/img/demo-custom-entities.mp4', '/img/demo-custom2.png']} />

        <div className={styles.content}>
          <br style={{ height: '10px' }} />
          <br style={{ height: '10px' }} />
          <h3 className={styles.header3}>Good looking default themes</h3>
          <p className={styles.sectionSubHeader}>Fully featured free online store and blog out of the box.</p>
          <br style={{ height: '10px' }} />
        </div>
        <CoverFlowImages
          images={['/img/demo-site1.png', '/img/demo-site2.png', '/img/demo-site3.png', '/img/demo-site4.png']}
        />
        ...
        <div className={styles.content}>
          ...
          <p className={styles.sectionSubHeader}>
            Make plugins that work with themes and can be statically pre-rendered by Next.js. Publish them to the market
            and let everyone use with a couple of clicks.
          </p>
          <br style={{ height: '10px' }} />
        </div>
        <CoverFlowImages images={['/img/demo-install-plugin.mp4']} />
        ...
        <div className={styles.content}>
          ...
          <p className={styles.sectionSubHeader}>
            Make themes by writing JSX code. We will build your Next.js app so representation of your code can be fully
            customized by your customers. Yes, these React components will be dragged/dropped/removed/styles in the
            theme editor!
          </p>
          <br style={{ height: '10px' }} />
        </div>
        <CoverFlowImages images={['/img/demo-theme-dev.png']} />
        ...
        <div className={styles.content}>
          ...
          <p className={styles.sectionSubHeader}>
            Make plugins to extend server API with the best enterprise-grade TypeScript frameworks: Nest.js, TypeGraphQL
            and TypeORM.
          </p>
          <br style={{ height: '10px' }} />
        </div>
        <CoverFlowImages images={['/img/demo-plugins-api.jpg']} />
        ...
        <div className={styles.content}>
          ...
          <p className={styles.sectionSubHeader}>
            Cromwell CMS follows principles of headless CMS. You can make any kind of custom frontend and query our API
            server with GraphQL.
          </p>
          <br style={{ height: '10px' }} />
        </div>
        <CoverFlowImages images={['/img/demo-headless.png']} />
        ...
        <div className={styles.content}>
          ...
          >
            <Link href="/docs/overview/intro">
              <Button style={{ margin: '0' }} variant="contained" className={styles.getStartedBtn}>
                Get started
              </Button>
            </Link>
            <Link href="/docs/overview/intro#examples" style={{ marginLeft: '30px' }}>
              <Button variant="contained" className={styles.examplesBtn}>
                Examples
              </Button>
            </Link>
          </div>
