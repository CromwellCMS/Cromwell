...
- [addToWatchedItems](#addtowatcheditems)
- [addToWishlist](#addtowishlist)
- [applyProductVariants](#applyproductvariants)
- [clearCart](#clearcart)
- [clearComparisionList](#clearcomparisionlist)
- [clearWatchedItems](#clearwatcheditems)
- [clearWishlist](#clearwishlist)
- [convertPrice](#convertprice)
- [getActiveCurrencySymbol](#getactivecurrencysymbol)
- [getActiveCurrencyTag](#getactivecurrencytag)
- [getCart](#getcart)
- [getCartTotal](#getcarttotal)
- [getCompare](#getcompare)
- [getDefaultCurrencyTag](#getdefaultcurrencytag)
- [getPrice](#getprice)
- [getPriceWithCurrency](#getpricewithcurrency)
- [getWatchedItems](#getwatcheditems)
- [getWishlist](#getwishlist)
- [hasSameQntInCart](#hassameqntincart)
- [isInCart](#isincart)
- [isInCompare](#isincompare)
- [isInWatchedItems](#isinwatcheditems)
- [isInWishlist](#isinwishlist)
- [onCartUpdate](#oncartupdate)
- [onCompareUpdate](#oncompareupdate)
- [onWatchedItemsUpdate](#onwatcheditemsupdate)
- [onWishlistUpdate](#onwishlistupdate)
- [removeFromCart](#removefromcart)
- [removeFromCompare](#removefromcompare)
- [removeFromWishlist](#removefromwishlist)
- [removeOnCartUpdate](#removeoncartupdate)
- [removeOnCompareUpdate](#removeoncompareupdate)
- [removeOnWatchedItemsUpdate](#removeonwatcheditemsupdate)
- [removeOnWishlistUpdate](#removeonwishlistupdate)
- [saveCart](#savecart)
- [saveWatchedItems](#savewatcheditems)
- [setActiveCurrency](#setactivecurrency)
- [updateCart](#updatecart)
- [updateComparisonList](#updatecomparisonlist)
- [updateQntInCart](#updateqntincart)
